...
\usepackage{graphbox} %used for vertical alignment of figures -Ross Magi, Feb 2020
...
\input{text/front_matter_and_coverQ4}
...
%\thispagestyle{empty}
%\addtocontents{toc}{\protect\enlargethispage{6\baselineskip}}
%
