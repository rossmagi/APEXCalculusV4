...
[width=175pt,tick label style={font=\scriptsize},axis on top,
			...
			xmin=-3.1,xmax=3.1,
			zmin=-20, zmax=20,
			every axis x label/.style={at={(axis cs:\pgfkeysvalueof{/pgfplots/xmax},0,0)},xshift=-2pt,yshift=0pt},
				xlabel={\scriptsize $x$},
			every axis y label/.style={at={(axis cs:0,\pgfkeysvalueof{/pgfplots/ymax},0)},xshift=2pt,yshift=0pt},
				ylabel={\scriptsize $y$},
...
\addplot3[domain=-3.2:3.2,,y domain=-2.2:2.2,surf,%fill=white,
colormap={mp2}{rgb=(0.7,0.7,1.0); rgb=(0.9,0.9,1.0)},
samples=25,samples y=25, z buffer=sort,%shader=interp,
%opacity=.75
] {4*x*y};

\addplot3 [thick,{\colortwo}, smooth,domain=0:2*pi,samples=25,samples y=0] ({3*cos(deg x)},{2*sin(deg x)},{24*sin(deg x)*cos(deg x)});
%\addplot3 [thick,{\colortwo}, smooth,dashed,opacity=.5,domain=0:2*pi,samples=25,samples y=0] ({3*cos(deg x)},{2*sin(deg x)},{-12});
...
\filldraw [black,] (axis cs:-2.1213,-1.4142,12) circle (1pt);
\filldraw [black,] (axis cs:2.1213,1.4142,12) circle (1pt);
\filldraw [black,] (axis cs:-2.1213,1.4142,-12) circle (1pt);
\filldraw [black,] (axis cs:2.1213,-1.4142,-12) circle (1pt);
